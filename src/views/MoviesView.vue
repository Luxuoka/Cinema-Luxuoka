  ...
  <div class="movies-view">
    <div class="view-header">
      <div class="header-main">
        <h1>Movies</h1>
        <p class="subtitle">Explore our collection of films</p>
      </div>
      ...
      <div class="filter-controls">
        ...
        <div class="dropdowns">
          <div class="select-wrapper">
            <select v-model="selectedYear" @change="loadMovies">
          ...
          <div class="select-wrapper">
            <select v-model="selectedCountry" @change="loadMovies">
          ...
          <div class="select-wrapper">
            <select v-model="sortBy" @change="loadMovies">
    ...
    <div v-else-if="movies.length > 0" class="content-grid">
      <ContentCard 
...
async function loadMovies() {
  ...
  try {
    if (localSearchQuery.value.trim()) {
      movies.value = await searchMovies(localSearchQuery.value.trim())
    } else {
      movies.value = await discoverMovies({
